...
public class AsyncGraphQLExecImpl implements AsyncGraphQLExec {
	...
	public AsyncGraphQLExecImpl(GraphQLSchema scheme) {
		this.graphQL = GraphQL.newGraphQL(scheme)
	...
	public Future<JsonObject> executeQuery(String query, Object context, Map<String, Object> variables) {
		...
		RxExecutionResult rxExecutionResult = (RxExecutionResult) graphQL.execute(query, context, variables != null ? variables : new HashMap<>());
